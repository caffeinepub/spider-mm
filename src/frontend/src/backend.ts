...
export class Backend implements backendInterface {
    ...
    async addToWaitlist(arg0: Email): Promise<void> {
    ...
    async getAllWaitlistEntriesSorted(): Promise<Array<WaitlistEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllWaitlistEntriesSorted();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalWaitlistEntries(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalWaitlistEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
